...
<tr>
  <td class='team' :class='{ winner: fwon, loser: uwon }' v-tooltip="teamsHover">
    <div class='team'>
  ...
  <td class='v' v-tooltip="teamsHover">
    –
  </td>
  <td class='team' :class='{ winner: uwon, loser: fwon }' v-tooltip="teamsHover">
    <div class='team'>
